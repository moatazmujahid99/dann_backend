                    ...
                    <div class="card radius-10 bg-gradient-deepblue">
                        <div class="card-body">
                            ...
                            <div class="progress my-3 bg-light-transparent" style="height:3px;">
                                <div class="progress-bar bg-white" role="progressbar" style="width: 3%" aria-valuenow="25"
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0 font-13 text-primary"><i class='bx bxs-up-arrow align-middle'></i>0
                                        EGP
                                        Since last week</p>
                                </div>
                                <div class="widgets-icons bg-light-success text-primary ms-auto"><i
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="widgets-icons bg-light-warning text-primary ms-auto"><i
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="widgets-icons bg-light-danger text-primary ms-auto"><i
                        ...
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>EGP 45.00</td>
                                    <td>
                                        <div class="badge rounded-pill bg-light-success text-success w-100">Completed
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex order-actions"> <a href="javascript:;" class=""><i
