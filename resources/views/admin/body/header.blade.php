        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ url('/all/review') }}"><i
                                class='bx bx-star'></i><span>Reviews</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ url('/product/all') }}"><i
                                class='bx bx-purchase-tag-alt'></i><span>Products</span></a>
                    </li>
                    <li>
