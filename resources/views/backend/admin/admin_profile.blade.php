                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted font-size-sm">Egypt</p>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li
                                            ...
                                            <span class="text-secondary">https://dann.store</span>
                                        </li>
                                        ...
                                        <li
                                            ...
                                            <span class="text-secondary">@dann</span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <form method="post" action="{{ route('user.profile.store') }}"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @if (Auth::guard('seller')->check())
                                            @if (isset($adminData->category->name))
                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                        <h6 class="mb-0">Category</h6>
                                                    </div>
                                                    <div class="col-sm-9 " style="color: black">
                                                        {{ $adminData->category->name }}
                                                    </div>
                                                </div>
                                            @endif
