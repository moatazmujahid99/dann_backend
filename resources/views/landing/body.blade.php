        ...
        <div class="row align-items-center">
            <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-10">
                <div class="hero-content">
                    ...
                    <p>Egypt's first social commerce platform. A High Technology Enabled E-Commerce Platform for Micro
                        and Small Businesses </p>
                    {{-- jetstram --}}
                    @if (Route::has('login'))
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block ">
                            @if (Auth::guard('seller')->check())
                                <a href="{{ route('seller.dashboard') }}" class="main-btn btn-hover">Go to the
                                    Dashboard</a>
                            @else
                                <a href="{{ route('seller.login') }}" class="main-btn btn-hover">Log in</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('seller.register') }}"
                                        class="main-btn btn-hover ms-3">Register</a>
                                @endif
                            @endauth
                    </div>
                @endif
        ...
        <div class="col-lg-4 col-md-6">
            <div class="single-feature">
                ...
                <div class="feature-content">
                    ...
                    <p>Connect with people nearby, build your business community, find new opportunities and much
                        more! </p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="single-feature">
                ...
                <div class="feature-content">
                    ...
                    <p>Explore thousands of products from local sellers near you, get your order in only few minutes
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-xxl-5 col-md-10 offset-xxl-1">
            <div class="feature-content-wrapper">
                <div class="section-title">
                    ...
                    <p class="mb-30">Dann Business Park, Egypt's first social commerce platform, that combines all
                        the pros of social media networks along with the power of online marketplaces, A powerful
                        website and mobile app, specially designed for local small and micro businesses.

                        We aim to make online local communities for trade and business in each city of Egypt, to
                        boost our economy, and help people grow their businesses. </p>
                    <a href="https://dann.store" target="_blank" class="main-btn btn-hover border-btn">Visit
                        Dann</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="single-feature">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>Find and follow nearby shops, service providers and hand-made artists, all
                                        gathered in one place, save your time, and shop from home</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="single-feature feature-2">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>Write about products, sellers, or about any interesting topics, and engage
                                        with your business community</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
